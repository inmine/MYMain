...
//    self.title = NSEaseLocalizedString(@"location.messageType", @"location message");
    self.title = NSEaseLocalizedString(@"位置信息", @"location message");
    
    UIButton *backButton = [[UIButton alloc] initWithFrame:CGRectMake(0, 0, 44, 44)];
//    [backButton setImage:[UIImage imageNamed:@"EaseUIResource.bundle/back"] forState:UIControlStateNormal];
    [backButton setTitle:@"返回" forState:UIControlStateNormal];
    [backButton setTitleColor:[UIColor colorWithRed:32 / 255.0 green:134 / 255.0 blue:158 / 255.0 alpha:1.0] forState:UIControlStateNormal];
...
//        [sendButton setTitle:NSEaseLocalizedString(@"send", @"Send")
        [sendButton setTitle:NSEaseLocalizedString(@"发送", @"Send") forState:UIControlStateNormal];
...
//    [self showHudInView:self.view hint:NSEaseLocalizedString(@"location.ongoning", @"locating...")];
    [self showHudInView:self.view hint:NSEaseLocalizedString(@"正在获取位置", @"locating...")];
}
